/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bb72ec56fa64fe621d2afacb05499154)
// Runtime types generated with workerd@1.20260701.1 2026-07-07 nodejs_compat
interface __BaseEnv_Env {
	keystone_studio: D1Database;
	VALUE_FROM_CLOUDFLARE: "Hello from Cloudflare";
	GOOGLE_FONTS_API_KEY: string;
	BUTTERY_TOKENS_STUDIO_IS_LOCAL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VALUE_FROM_CLOUDFLARE" | "GOOGLE_FONTS_API_KEY" | "BUTTERY_TOKENS_STUDIO_IS_LOCAL" | "BUTTERY_TOKENS_STUDIO_CONFIG_PATH" | "BUTTERY_TOKENS_STUDIO_VERSION_DIR">> {}
}
